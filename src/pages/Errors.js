...
function Form() {
    ...
    const handleClick = async ()=>{
      ...
      const data = {
  "model": "llama3",
  "prompt": "What is the error in the following stacktrace:- "+data3+" Please answer in less than 100 words",
  "stream":false
    ...
    return (
         ...
         >
            <Stack  direction="row" spacing={0.5}>
                <Stack  spacing={2}>
                  <MultilineTextFields parentCallback={handleCallback} label="Paste stacktrace here"/>
